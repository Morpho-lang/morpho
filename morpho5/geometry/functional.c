...
static bool functional_numericalhessian(vm *v, objectmesh *mesh, elementid i, int nv, int *vid, functional_integrand *integrand, void *ref, objectsparse *hess) {
    ...
    double d2xx[] = { -1.0, 2*eps, 0, // Data for second derivative formula
                     -1.0,-2*eps, 0,
                    -30.0,     0, 0,
                    +16.0,  +eps, 0,
                    +16.0,  -eps, 0};
    
    double d2yy[] = { -1.0, 0, 2*eps, // Data for second derivative formula
                     -1.0,  0,-2*eps,
                    -30.0,  0, 0,
                    +16.0,  0, eps,
                    +16.0,  0,-eps};
    ...
    double *d2,scale=1.0;
    int neval, nevalxx=5, nevalyy=5, nevalxy=4;
