...
MORPHO_METHOD_SIGNATURE(JSON_PARSEMETHOD, "(String)", JSON_parse, MORPHO_FN_ALLOCATES|MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(JSON_PARSEMETHOD, "(...)", JSON_parse__err, MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(MORPHO_TOSTRING_METHOD, "(_)", JSON_tostring, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_TOSTRING_METHOD, "(...)", JSON_tostring__err, MORPHO_FN_NONE)
MORPHO_ENDCLASS
