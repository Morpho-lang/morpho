...
MORPHO_METHOD(MORPHO_GETINDEX_METHOD, Object_getindex, MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_SETINDEX_METHOD, Object_setindex, MORPHO_FN_MUTATES|MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_CLASS_METHOD, Object_class, MORPHO_FN_PUREFN),
MORPHO_METHOD(MORPHO_SUPER_METHOD, Object_super, MORPHO_FN_PUREFN),
MORPHO_METHOD(MORPHO_RESPONDSTO_METHOD, Object_respondsto, MORPHO_FN_ALLOCATES|MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_HAS_METHOD, Object_has, MORPHO_FN_ALLOCATES|MORPHO_FN_THROWS),
...
MORPHO_METHOD(MORPHO_COUNT_METHOD, Object_count, MORPHO_FN_PUREFN),
MORPHO_METHOD(MORPHO_ENUMERATE_METHOD, Object_enumerate, MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_SERIALIZE_METHOD, Object_serialize, MORPHO_FN_NONE),
MORPHO_METHOD(MORPHO_CLONE_METHOD, Object_clone, MORPHO_FN_PUREFN|MORPHO_FN_ALLOCATES|MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_LINEARIZATION_METHOD, Object_linearization, MORPHO_FN_PUREFN|MORPHO_FN_ALLOCATES)
MORPHO_ENDCLASS
