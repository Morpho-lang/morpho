...
#define HYDROGEL_ARGS_MSG              "Hydrogel requires a reference mesh and allows 'grade', 'a', 'b', 'c' and 'phi0' as optional arguments."

#define HYDROGEL_PRP                   "HydrglPrp"
#define HYDROGEL_PRP_MSG               "Hydrogel requires properties 'reference' to be a mesh, 'grade' to be an integer grade, 'a', 'b' and 'c' to be numbers and 'phi0' as either a number or a field."
