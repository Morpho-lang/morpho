...
MORPHO_METHOD_SIGNATURE(MORPHO_SUB_METHOD, "Complex (Complex)", Complex_sub__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_SUB_METHOD, "Complex (_)", Complex_sub__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_MUL_METHOD, "Complex (Complex)", Complex_mul__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_MUL_METHOD, "Complex (_)", Complex_mul__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_DIV_METHOD, "Complex (Complex)", Complex_div__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_DIV_METHOD, "Complex (_)", Complex_div__x, BUILTIN_FLAGSEMPTY),
...
MORPHO_METHOD_SIGNATURE(MORPHO_SUBR_METHOD, "Complex (_)", Complex_subr__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_MULR_METHOD, "Complex (Complex)", Complex_mul__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_MULR_METHOD, "Complex (_)", Complex_mul__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_DIVR_METHOD, "Complex (_)", Complex_divr__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_POW_METHOD, "Complex (Complex)", Complex_power__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_POW_METHOD, "Complex (_)", Complex_power__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_POWR_METHOD, "Complex (Complex)", Complex_powerr__complex, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_POWR_METHOD, "Complex (_)", Complex_powerr__x, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(COMPLEX_ANGLE_METHOD, "Float ()", Complex_angle, MORPHO_FN_PUREFN),
MORPHO_METHOD_SIGNATURE(COMPLEX_CONJUGATE_METHOD, "Complex ()", Complex_conjugate, MORPHO_FN_ALLOCATES),
...
MORPHO_METHOD_SIGNATURE(MORPHO_CLONE_METHOD, "Complex ()", Complex_clone, MORPHO_FN_ALLOCATES)
MORPHO_ENDCLASS
