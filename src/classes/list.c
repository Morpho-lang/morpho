...
MORPHO_METHOD_SIGNATURE(MORPHO_CLONE_METHOD, "List ()", List_clone, MORPHO_FN_ALLOCATES),
//MORPHO_METHOD(MORPHO_ADD_METHOD, List_add, BUILTIN_FLAGSEMPTY),
MORPHO_METHOD_SIGNATURE(MORPHO_JOIN_METHOD, "List (List)", List_join__list, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_ROLL_METHOD, "List (Int)", List_roll, MORPHO_FN_ALLOCATES),
...
MORPHO_METHOD_SIGNATURE(LIST_ORDER_METHOD, "Tuple ()", List_order, MORPHO_FN_ALLOCATES),
