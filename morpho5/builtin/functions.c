...
#ifdef GPU_ACC
BUILTIN_TYPECHECK(isgpumatrix, MORPHO_ISGPUMATRIX)
BUILTIN_TYPECHECK(isgpusparse, MORPHO_ISGPUSPARSE)
#endif
...
void functions_initialize(void) {
    ...
    #ifdef GPU_ACC
    BUILTIN_TYPECHECK(isgpusparse)
    BUILTIN_TYPECHECK(isgpumatrix)
    #endif
