...
MORPHO_METHOD_SIGNATURE(DICTIONARY_KEYS_METHOD, "List ()", Dictionary_keys, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_CLONE_METHOD, "Dictionary ()", Dictionary_clone, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_UNION_METHOD, "Dictionary (Dictionary)", Dictionary_union, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_UNION_METHOD, "Nil (...)", Dictionary_union__err, MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(MORPHO_INTERSECTION_METHOD, "Dictionary (Dictionary)", Dictionary_intersection, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_INTERSECTION_METHOD, "Nil (...)", Dictionary_intersection__err, MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(MORPHO_DIFFERENCE_METHOD, "Dictionary (Dictionary)", Dictionary_difference, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_DIFFERENCE_METHOD, "Nil (...)", Dictionary_difference__err, MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(MORPHO_ADD_METHOD, "Dictionary (Dictionary)", Dictionary_union, MORPHO_FN_ALLOCATES),
MORPHO_METHOD_SIGNATURE(MORPHO_ADD_METHOD, "Nil (...)", Dictionary_union__err, MORPHO_FN_THROWS),
MORPHO_METHOD_SIGNATURE(MORPHO_SUB_METHOD, "Dictionary (Dictionary)", Dictionary_difference, MORPHO_FN_ALLOCATES),
