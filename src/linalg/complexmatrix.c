...
MORPHO_METHOD_SIGNATURE(MORPHO_GETINDEX_METHOD, "ComplexMatrix (...)", Matrix_index__err, MORPHO_FN_PUREFN),
...
MORPHO_METHOD_SIGNATURE(MATRIX_INNER_METHOD, "Complex (ComplexMatrix)", ComplexMatrix_inner, BUILTIN_FLAGSEMPTY),
