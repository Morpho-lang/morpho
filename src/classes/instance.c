...
MORPHO_METHOD(MORPHO_CLONE_METHOD, Object_clone, MORPHO_FN_ALLOCATES|MORPHO_FN_THROWS),
MORPHO_METHOD(MORPHO_LINEARIZATION_METHOD, Object_linearization, MORPHO_FN_ALLOCATES)
MORPHO_ENDCLASS
